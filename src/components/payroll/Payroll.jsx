                        ...
                        download ?
                            <div className='border-2 rounded-md'>
                                ...
                                <div className='flex gap-2 px-2'>
                                    <a href={'http://127.0.0.1:8000/wages/' + watch('Site') + '/' + watch('month') + "/download"} target='_blank'> Wages</a>
                                    <a href={'http://127.0.0.1:8000/summary/' + watch('Site') + '/' + watch('month') + "/download"} target='_blank'>Summary</a>
