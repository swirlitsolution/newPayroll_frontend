                      ...
                      {props.employee && props.employee.length > 0 ? (
                        props.employee.map((emp, index) => (
                          <tr key={index} className="hover:bg-gray-50">
                            ...
                            <td className="border border-gray-400 p-1 text-center">
                              {emp.employeeData_DesignationDetails_name ||
                                emp.Designation ||
                                ""}
                            </td>
                            <td className="border border-gray-400 p-1 text-center">
                              ...
                              <div className="text-[9px]">
                                {emp.tnhday ? `NH : ${emp.tnhday}` : ""}
                              </div>
                              <div className="text-[9px]">
                                {emp.tel ? `EL: ${emp.tel}` : ""}
                              </div>
                              <div className="text-[9px]">
                                {emp.tcl ? `CL: ${emp.tcl || "0"}` : ""}
                              </div>
                              <div className="text-[9px]">
                                {emp.tfl ? `FL: ${emp.tfl || "0"}` : ""}
                              </div>
                              <div className="border-t border-gray-400 text-[9px] font-bold">
                                {emp.tpayable || "0.00"}
                              </div>
                            </td>
                            <td className="border border-gray-400 p-1">
                              ...
                              <div className="border-t border-gray-400 text-right font-bold">
                                {emp.bdarate || "0.00"}
                              </div>
                            </td>
                    ...
                    <table className="w-full text-xs font-semibold">
                      <tbody className="border border-gray-300">
                        <tr>
                          <td className="p-2">
                            Basic:{" "}
                            <span className="font-bold">{totals.tbasic}</span>
                          </td>
                          <td className="p-2">
                            DA: <span className="font-bold">{totals.tda}</span>
                          </td>
                          <td className="p-2">
                            Total Attn:{" "}
                          ...
                          <td className="p-2">
                            Gross Payment:{" "}
                            <span className="font-bold">{totals.tgross}</span>
                          </td>
                          <td className="p-2">
                            PF Amt:{" "}
                            <span className="font-bold">{totals.tpf}</span>
                          </td>
                          <td className="p-2">
                            ESIC Amt:{" "}
                            <span className="font-bold">{totals.tesic}</span>
                          </td>
                          <td className="p-2">
                            Net Payment:{" "}
                            <span className="font-bold">{totals.tnetamt}</span>
                          </td>
                        </tr>
                        <tr>
                          <td className="p-2"></td>
                          ...
                          <td className="p-2">
                            Total Other Payment:{" "}
                            <span className="font-bold">{totals.tmrpot}</span>
                          </td>
                          <td className="p-2"></td>
                          <td className="p-2"></td>
                          <td className="p-2"></td>
