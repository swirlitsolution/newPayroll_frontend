            ...
            <div ref={contentRef}>
              ...
              <div className='grid grid-cols-2 gap-4 mt-4'>
                <div>
                  ...
                  <p className='text-left text-sm font-semibold'>{props.company?.worknaturedata?.name || props.company?.workNature || 'N/A'}</p>
                </div>
                <div>
                  <p className='text-left text-sm'>Name & Address of the Establishment in / under which contract is carried on</p>
                  <p className='text-left text-sm font-semibold'>{props.company?.contractdata?.name || props.company?.contractEstablishment || 'N/A'}</p>
                  <p className='text-left text-sm mt-2'>Name & Address of Principal Employer</p>
                  <p className='text-left text-sm font-semibold'>{props.company?.principledata?.name || props.company?.principleEmployer || 'N/A'}</p>
                </div>
              </div>
