                    ...
                    <div className="w-full mt-2 flex flex-col gap-4">
                        <div className='w-full flex justify-between '>
                            ...
                            <div className=" text-end  w-[50%]">
                                ...
                                <p className="text-sm text-gray-600">{company?.contractdata?.name || company?.contractEstablishment || 'N/A'}</p>
                            </div>
                        </div>
                        <div className='w-full flex justify-between'>
                            <div className="text-start  w-[50%]">
                                <h2 className="text-lg font-semibold">Name & Location of Work  </h2>
                                <p className="text-sm text-gray-600">{company?.worknaturedata?.name || company?.workNature || 'N/A'}</p>
                            </div>
                            <div className="text-end  w-[50%]">
                                <h2 className="text-lg font-semibold">Name & Address of Principal Employer   :</h2>
                                <p className="text-sm text-gray-600">{company?.principledata?.name || company?.principleEmployer || 'N/A'}</p>
                            </div>
