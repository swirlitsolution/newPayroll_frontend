...
function OdishaOverTimeRegister(props) {
    ...
    <div>
      {
        props?.company && (
          <div className='w-full flex flex-col'>
            <button onClick={reactToPrintFn} className='mb-4 float-right px-4 py-2 w-16 bg-blue-600 text-white rounded hover:bg-blue-700'>
              Print
            </button>
              ...
              <div ref={contentRef}>
                ...
                {/* <div className='grid grid-cols-2 gap-4 mt-4'>
                      ...
                      <div className='text-right'>
                          ...
                          <p className='text-right text-xs'>contract is carried on: {props.company?.contractdata?.name || props.company?.contractEstablishment || 'N/A'}</p>
                          <p className='text-right text-xs'>Name & Address of Principal Employer: {props.company?.principledata?.name || props.company?.principleEmployer || 'N/A'}</p>
                      </div>
                  </div> */}
...
export default OdishaOverTimeRegister
