...
function NewEmployee(props) {
    ...
    const { data, error, loading, postRequest} = usePost("/master/employee/")
                ...
                <div className='flex justify-between '>
                    ...
                    <Controller
                       ...
                       return (
                            ...
                            value={value} name='site' add={true} />
                       );
                        }}
                    />
                    ...
                    <div className='flex items-center gap-2'>
                        <Label htmlFor='empid' className='text-right '>EmpId</Label>
                ...
                <div className='grid grid-cols-6 gap-x-2 gap-y-2 mt-4 items-center'>
                    ...
                    <Controller
                       ...
                       return (
                            ...
                            onValueChange={(newValue) => onChange(newValue || null)} 
                            value={value} name='department' add={true} />
                       );
                        }}
                    />
                    ...
                    <Controller
                       ...
                       return (
                            ...
                            onValueChange={(newValue) => onChange(newValue || null)} 
                            value={value} name='designation' add={true} />
                       );
                        }}
                    />
                    ...
                    <Label htmlFor='aadhar' className='text-left'>Aadhar</Label>
