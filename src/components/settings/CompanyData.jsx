        ...
        <div className='w-full'>
            ...
            <div className='grid grid-cols-2 gap-2 mt-2'>
                ...
                <div>
                    ...
                    <div>{company?.worknaturedata?.name || company?.workNature}</div>
                </div>
                <div>
                    <div className='font-semibold'>Contract Establishment:</div>
                    <div>{company?.contractdata?.name || company?.contractEstablishment}</div>
                </div>
                <div>
                    <div className='font-semibold'>Principle Employer:</div>
                    <div>{company?.principledata?.name || company?.principleEmployer}</div>
                </div>
            </div>
